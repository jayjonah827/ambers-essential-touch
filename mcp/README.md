...
- Service and product tools preserve all observations while `content/project_context.json` supplies the resolved authority: detailed uploaded services are canonical; grouped generated-specification and older-site values are historical research; repeated existing product prices are working evidence; generated relaunch values are excluded concepts.
